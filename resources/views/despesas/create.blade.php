...
@section('modal-content')
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input name="nome_despesa" type="text" class="form-control" />
            ...
            <div class="form-group">
                ...
                <div>
                    <label class="float-end">
                        <a role="button" href="#formAddTipoDespesa" id="newTipoDespesa" data-bs-toggle="collapse"
                            aria-expanded="true" aria-controls="formAddTipoDespesa">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="collapse" id="formAddTipoDespesa" style="border: 1px solid #435ebe; margin:10px;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2" style="margin-top:3%;">
                                <button class="btn btn-success" type="button" id="btnAddTipoDespesa">
                                    Salvar
                                </button>
                            </div>
                        </div>
