                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="mes">
                                        @foreach ($optionsMeses as $k => $v)
                                            <option value="{{ $k }}" @if ($k == date('m')) selected @endif>
                                                {{ $v }} </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <div id="gridLancamentos">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4> Quantidade atual : R$ {{ convertValorReal($totalProventos - $totalLancamentos) }} </h4>
            </div>
        </div>
        <div class="row" style="margin-top:3%">
            ...
            <div class="col-md-6 col-lg-6">
                <h6> Despesas - total: {{" R$ ".convertValorReal($valorTotalDespesa)}} </h6>
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($dataLancamentosDespesa as $lancamentoDespesa)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button id="{{ $lancamentoDespesa->id }}"
                                                        class="btn btn-danger rounded-pill btnExcluirLancamento">
            ...
            @endforeach
            <div class="col-md-6 col-lg-6">
                <h6> Outros gastos - total: {{ "R$" . convertValorReal($valorTotalOutros) }} </h6>
                <div class="card">
                    <div class="card-body">
                        <div class="card-content table-responsive">
                            <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($dataOutrosLancamentos as $outrosLancamentos)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button id="{{ $outrosLancamentos->id }}"
                                                        class="btn btn-danger rounded-pill btnExcluirLancamento">
                                                        <i class="fa fa-trash"> </i>
                                                    </button>
                                                </td>
