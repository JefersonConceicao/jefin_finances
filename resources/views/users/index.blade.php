                                ...
                                <tbody>
                                    @foreach ($dataUsers as $user)
                                        <tr>
                                            ...
                                            <td> {{ $user->email }} </td>
                                            <td> {{ $user->last_login ? converteData($user->last_login, 'd/m/Y H:i:s') : "Não informado"}} </td>
                                            <td>
                                            ...
                                            @if (Auth::user()->id == 16)
                                                <td>
                                                    <div class="text-center" style="display:flex;">
                                                        <button class="btnEditUser btn btn-secondary rounded-pill"
                                                            id="{{ $user->id }}">
                                                            <i class="fa fa-edit"> </i>
                                                        </button>
                                                        &nbsp;
                                                        <button class="btnDeleteUser btn btn-danger rounded-pill"
                                                            id="{{ $user->id }}">
