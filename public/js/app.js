...
var formLoginUser = function formLoginUser() {
  var url = '/login';
  ...
  $.ajax({
    ...
    complete: function complete() {
      $(form + " .btn-primary").prop("disabled", false).html('Log in');
    }
  });
};
...
var eventsHelper = function eventsHelper() {
...
/***/ "./resources/js/Logged/AppDashboard.js":
/*!*********************************************!*\
  !*** ./resources/js/Logged/AppDashboard.js ***!
  \*********************************************/
/*! no static exports found */
  ...
  var chart = new Chart(myGraph, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [20, 20, 20],
        backgroundColor: ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.4)', 'rgba(255, 206, 86, 0.3)']
      }]
    }
  });
};
...
var getFilterUsers = function getFilterUsers(urlPaginate) {
  var url = '/users/';
  var form = "#searchFormUsers";
  $.ajax({
    type: "GET",
    url: url,
    data: $(form).serialize(),
